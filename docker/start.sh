...
pm2 start server-wrapper.js --cwd /app/web --name funeralacademy-web > /dev/null 2>&1
pm2 start uv --cwd /app/api --name funeralacademy-api -- run app.py
pm2 start node --cwd /app/collab --name funeralacademy-collab -- dist/index.js
