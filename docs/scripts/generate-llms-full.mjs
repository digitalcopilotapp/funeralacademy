...
const API_BASE_URL = (process.env.FUNERALACADEMY_API_URL || 'https://api.funeralacademy.io').replace(/\/$/, '')
...
sections.push('# FuneralAcademy Documentation — Full Content')
sections.push('')
sections.push('> This file contains the complete text of all FuneralAcademy documentation pages.')
...
sections.push('---')
sections.push('')
sections.push('# FuneralAcademy API Reference')
