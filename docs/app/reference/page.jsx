...
export const metadata = {
  title: 'API Reference',
  description:
    'Complete reference for the FuneralAcademy REST API — endpoints, request and response schemas, code examples and a live playground.',
  ...
  return (
    <div className="lh-ref-overview">
      <header className="lh-ref-overview-head">
        ...
        <h1 className="lh-ref-overview-title">The FuneralAcademy API</h1>
        <p className="lh-ref-overview-lede">
          A REST API for driving FuneralAcademy programmatically — {totalOps} documented endpoints
