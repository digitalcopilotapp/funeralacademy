...
function EditOnGitHub({ filePath }) {
  ...
  // lives under docs/ in the funeralacademy monorepo, so prefix with that. Using it
    ...
    >
      ...
      <div className="relative p-4">
        <div className="flex items-center gap-2.5" style={{ marginBottom: 16 }}>
          <img src="/img/logos/funeralacademy-dark.svg" alt="FuneralAcademy" className="h-3.5" />
          <span
