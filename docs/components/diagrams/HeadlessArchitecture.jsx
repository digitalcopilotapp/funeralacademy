...
// Browser → your Next.js app (BFF) → FuneralAcademy API. Media streams straight
...
const nodes = [
  ...
  { label: 'FuneralAcademy API', sub: '/api/v1', icon: Cube, color: '#10b981', bg: '#ecfdf5', border: '#a7f3d0' },
]
