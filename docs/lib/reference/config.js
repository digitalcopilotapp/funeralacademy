...
export const API_BASE_URL = (
  process.env.FUNERALACADEMY_API_URL || 'https://api.funeralacademy.io'
).replace(/\/$/, '')
...
export const API_GROUPS = [
  ...
  },
  {
    ...
    access: 'session',
    rightsBucket: null,
    description: 'Register HTTP endpoints that receive event notifications from FuneralAcademy.',
  },
  {
    slug: 'headless',
    title: 'Headless',
