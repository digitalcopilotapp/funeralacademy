...
Before installing FuneralAcademy, ensure your server meets the following requirements.
...
| Node.js | 18+ | Required to run the FuneralAcademy CLI |
...
FuneralAcademy is supported on:
