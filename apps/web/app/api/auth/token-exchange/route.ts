...
const BACKEND_URL = (getConfig('NEXT_PUBLIC_FUNERALACADEMY_BACKEND_URL') || 'http://localhost:1338').replace(/\/+$/, '')
// Dormant cross-domain handoff safety valve. Post funeralacademy.app deprecation the
...
const PLATFORM_URL = (getConfig('NEXT_PUBLIC_FUNERALACADEMY_PLATFORM_URL') || getConfig('FUNERALACADEMY_PLATFORM_URL') || '').replace(/\/+$/, '')
