...
import { getFUNERALACADEMY_DOMAIN_VAL, getFUNERALACADEMY_TOP_DOMAIN_VAL, getAPIUrl } from '@services/config/config'
...
export default function GoogleCallbackPage() {
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      // Google redirects to the main domain (dev.funeralacademy.io). We detect this
