                    ...
                    <div className="w-full max-w-[420px] py-10">
                        ...
                        {!isVerifying && error && (
                            <div className="mt-8 space-y-5">
                                ...
                                <Link
                                    href="/login"
                                    className="box-border w-full inline-flex h-[44px] rounded-lg items-center justify-center bg-[var(--brand)] hover:bg-[var(--brand-hover)] text-[var(--brand-contrast)] px-[15px] font-bold text-[14px] leading-none transition-all"
                                >
