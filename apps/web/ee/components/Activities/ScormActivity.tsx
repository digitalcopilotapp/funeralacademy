          ...
          nestedIframes?.forEach((nestedIframe: HTMLIFrameElement) => {
            try {
              if (nestedIframe.contentDocument) {
                ...
                nestedStyle.id = 'funeralacademy-scorm-styles'
                ...
                `
                // Remove any existing funeralacademy styles first
                const existing = nestedIframe.contentDocument.getElementById('funeralacademy-scorm-styles')
