...
const SENTRY_DSN = rc.NEXT_PUBLIC_FUNERALACADEMY_SENTRY_DSN || process.env.NEXT_PUBLIC_FUNERALACADEMY_SENTRY_DSN;
const FUNERALACADEMY_ENV = rc.NEXT_PUBLIC_FUNERALACADEMY_ENV || process.env.NEXT_PUBLIC_FUNERALACADEMY_ENV || "dev";
