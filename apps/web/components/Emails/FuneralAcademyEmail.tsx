...
export interface FuneralAcademyEmailProps {
  accentColor: string
  heading: string
  subtitle: string
  body?: string
...
const LOGO_URL = 'https://www.funeralacademy.io/funeralacademy-dark.svg'

export function FuneralAcademyEmail({
  accentColor,
  heading,
  subtitle,
  body,
      ...
      <Body style={{ backgroundColor: '#f5f5f5', fontFamily: 'Inter, Helvetica, Arial, sans-serif', margin: 0, padding: '24px 0' }}>
        <Container style={{ backgroundColor: '#ffffff', borderRadius: 16, overflow: 'hidden', maxWidth: 560, margin: '0 auto', border: '1px solid #eee' }}>
          ...
          <Section style={{ padding: '32px 40px 8px' }}>
            <Img src={LOGO_URL} alt="Funeral Academy" height={28} style={{ marginBottom: 24 }} />
          ...
          <Section style={{ padding: '16px 40px 32px' }}>
            <Text style={{ fontSize: 12, color: '#a3a3a3', margin: 0 }}>
              Funeral Academy — the open-source learning platform.
            </Text>
          </Section>
        </Container>
      </Body>
...
export default FuneralAcademyEmail
