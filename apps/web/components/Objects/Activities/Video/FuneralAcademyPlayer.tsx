...
interface FuneralAcademyPlayerProps {
  src: string
 ...
 */
const FuneralAcademyPlayer: React.FC<FuneralAcademyPlayerProps> = ({
  src,
  isHls = false,
  fallbackSrc,
  details,
  ...
  return (
    ...
    // everywhere anyway.
    <div dir="ltr" className="funeralacademy-player relative w-full h-full" data-vjs-player>
...
export default FuneralAcademyPlayer
