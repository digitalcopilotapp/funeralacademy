...
let SENTRY_DSN = process.env.NEXT_PUBLIC_FUNERALACADEMY_SENTRY_DSN;
let FUNERALACADEMY_ENV = process.env.NEXT_PUBLIC_FUNERALACADEMY_ENV || "dev";
  ...
  for (const configPath of possiblePaths) {
    try {
      if (fs.existsSync(configPath)) {
        ...
        SENTRY_DSN = rc.NEXT_PUBLIC_FUNERALACADEMY_SENTRY_DSN || SENTRY_DSN;
        FUNERALACADEMY_ENV = rc.NEXT_PUBLIC_FUNERALACADEMY_ENV || FUNERALACADEMY_ENV;
        break;
      }
    } catch {
