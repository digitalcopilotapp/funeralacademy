 ...
 *
 * Boots a real FuneralAcademy self-host using the FuneralAcademy CLI (`setup --ci`,
...
function bootSelfHost(): void {
  console.log(`Booting FuneralAcademy self-host via CLI (install "${INSTALL_NAME}")…`)
  const cmd = [
    CLI,
    'setup',
    '--ci',
...
export default async function globalSetup(): Promise<void> {
  ...
  console.log(`FuneralAcademy is ready at ${BASE_URL}. Admin: ${ADMIN_EMAIL}`)
