 ...
 *  - a self-host the suite boots itself via the FuneralAcademy CLI (default), or
...
/** CLI install name (also the docker-compose project dir under ~/.funeralacademy). */
...
export const CLI = process.env.E2E_CLI || 'npx --yes funeralacademy@latest'
