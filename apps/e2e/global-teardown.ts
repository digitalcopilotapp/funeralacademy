 ...
 * the compose file the CLI generated under ~/.funeralacademy/<name>/. We avoid
 * `funeralacademy stop` here because it can prompt interactively when more than one
...
export default async function globalTeardown(): Promise<void> {
  ...
  const composePath = join(homedir(), '.funeralacademy', INSTALL_NAME, 'docker-compose.yml')
