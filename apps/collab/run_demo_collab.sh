...
export FUNERALACADEMY_API_URL="http://lvh.me:1348"
# FUNERALACADEMY_REDIS_URL, not the API's FUNERALACADEMY_REDIS_CONNECTION_STRING —
...
export FUNERALACADEMY_REDIS_URL="redis://localhost:6379/0"
