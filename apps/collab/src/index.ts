...
const API_URL = process.env.FUNERALACADEMY_API_URL || 'http://localhost:8000'
const SECRET_KEY = process.env.FUNERALACADEMY_AUTH_JWT_SECRET_KEY || ''
const INTERNAL_KEY = process.env.COLLAB_INTERNAL_KEY || ''
const REDIS_URL = process.env.FUNERALACADEMY_REDIS_URL || 'redis://localhost:6379'
...
if (!SECRET_KEY) {
  console.error('[collab] FATAL: FUNERALACADEMY_AUTH_JWT_SECRET_KEY is not set')
  process.exit(1)
}
