...
if is_testing:
    ...
    sql_url = str(funeralacademy_config.database_config.sql_connection_string)  # type: ignore
    ...
    is_pooled = (
        ...
        or os.getenv("FUNERALACADEMY_PGBOUNCER", "").lower() in ("1", "true", "yes")
    )
...
_STARTUP_CONNECT_ATTEMPTS = int(os.getenv("FUNERALACADEMY_DB_STARTUP_ATTEMPTS", "5"))
