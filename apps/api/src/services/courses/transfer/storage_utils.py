...
def get_content_delivery_type() -> str:
    ...
    return funeralacademy_config.hosting_config.content_delivery.type
...
def get_storage_client():
    ...
    with _s3_client_lock:
        ...
        # Overridable via FUNERALACADEMY_S3_API_REGION for real AWS S3 / MinIO, which
        # validate the region against the endpoint.
        region = os.environ.get("FUNERALACADEMY_S3_API_REGION") or "auto"
        _s3_client = boto3.client(
            "s3",
            endpoint_url=funeralacademy_config.hosting_config.content_delivery.s3api.endpoint_url,
            region_name=region,
...
def get_s3_bucket_name() -> str:
    ...
    funeralacademy_config = get_funeralacademy_config()
    return funeralacademy_config.hosting_config.content_delivery.s3api.bucket_name or "funeralacademy-media"
