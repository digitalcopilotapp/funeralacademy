...
config value (``FUNERALACADEMY_AI_TTS_MODEL``), never hard-coded into behaviour.
"""
...
# Override with FUNERALACADEMY_AI_TTS_MODEL (e.g. gemini-2.5-pro-preview-tts for higher
...
def _resolve_tts_config() -> tuple[str, str]:
    ...
    if not api_key:
        raise AINotConfiguredError(
            ...
            "(set FUNERALACADEMY_GEMINI_API_KEY, or FUNERALACADEMY_AI_API_KEY when "
            "FUNERALACADEMY_AI_PROVIDER=google)."
        )
