...
async def upload_content(
    ...
    content_delivery = funeralacademy_config.hosting_config.content_delivery.type
    ...
    if content_delivery == "filesystem":
        ...
        bucket_name = funeralacademy_config.hosting_config.content_delivery.s3api.bucket_name or "funeralacademy-media"
