...
def test_resolve_config_google_uses_api_key():
    with patch.object(gen, "get_funeralacademy_config", return_value=_cfg(provider="google", api_key="gk")):
...
def test_resolve_config_non_google_falls_back_to_gemini_key():
    ...
    with patch.object(gen, "get_funeralacademy_config", return_value=cfg):
...
async def test_generate_image_success():
    ...
    with patch.object(gen, "get_funeralacademy_config", return_value=_cfg()), patch(
