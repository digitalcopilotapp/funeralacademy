...
# Going through FUNERALACADEMY_DISABLE_EE rather than patching
...
os.environ["FUNERALACADEMY_DISABLE_EE"] = "1"
...
# demo stack has FUNERALACADEMY_DEMO_ENABLED=1 in apps/api/.env and it leaks into
...
os.environ["FUNERALACADEMY_DEMO_ENABLED"] = "0"

# Set a valid JWT secret key for tests (must be at least 32 characters)
os.environ["FUNERALACADEMY_AUTH_JWT_SECRET_KEY"] = (
