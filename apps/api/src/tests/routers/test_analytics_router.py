...
class TestAnalyticsHelpers:
    ...
    def test_get_read_client_handles_missing_and_configured_tinybird(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "src.routers.analytics.get_funeralacademy_config",
...
class TestAnalyticsRouter:
    async def test_status_and_plan_info(self, client, app):
        with patch("src.routers.analytics.get_funeralacademy_config", return_value=SimpleNamespace(tinybird_config=None)):
