...
JWT_COOKIE_DOMAIN = get_funeralacademy_config().hosting_config.cookie_config.domain
...
def _refresh_token_lifetime() -> timedelta:
    ...
    Overridable with ``FUNERALACADEMY_AUTH_REFRESH_TOKEN_DAYS`` for operators who
    ...
    """
    import os
    raw = os.environ.get("FUNERALACADEMY_AUTH_REFRESH_TOKEN_DAYS")
    if raw:
        try:
            days = int(raw)
